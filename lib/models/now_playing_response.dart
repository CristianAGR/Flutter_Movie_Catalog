...
class NowPlayingResponse {
  ...
  // constructor
    ...
    int totalPages;
    int totalResults;
    // crea una instancia de fromMap que recibe un json
    ...
    factory NowPlayingResponse.fromMap(Map<String, dynamic> json) => NowPlayingResponse(
        ...
        page:         json["page"],
        // se recibe un listado y se crean instancias independientes de movie
        results:      List<Movie>.from(json["results"].map((x) => Movie.fromMap(x))),
        totalPages:   json["total_pages"],
        totalResults: json["total_results"],
    );

    // crea un mapa que sería necesario si se quiere mandar la info a una petición http.post
